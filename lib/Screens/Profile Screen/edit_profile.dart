...
// import 'package:serial_reg/Screens/Authentication/Models/personal_information.dart';
    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        child: Consumer(builder: (context, ref, child) {
          ...
          // if (loopCount == 1) {
          //   dropdownValue =
          //       userProfileDetails.value!.businessCategory.toString();
                    ...
                    Padding(
                      ...
                      child: SizedBox(
                        ...
                        child: AppTextField(
                          ...
                          readOnly: true,
                          controller:
                              TextEditingController(text: initialCountry),
                          decoration: InputDecoration(
