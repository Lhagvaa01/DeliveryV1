...
import 'package:deliery_app/Screens/CustomersOld/edit_customer.dart';
        ...
        body: SingleChildScrollView(
          child: Column(
            children: [
              ...
              Row(
                ...
                children: [
                  GestureDetector(
                    onTap: () async {
                      final Uri url =
                          Uri.parse('tel:${widget.customerModel.phoneNumber}');
                  ...
                  GestureDetector(
                    onTap: () async {
                      final Uri url =
                          Uri.parse('sms:${widget.customerModel.phoneNumber}');
              ...
              //             return transaction[index].customerPhone ==
              //                     widget.customerModel.phoneNumber
              //                 ? Column(
              //                     children: [
              //                       Container(
