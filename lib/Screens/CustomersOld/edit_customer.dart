...
import 'package:deliery_app/Screens/CustomersOld/Model/customer_model.dart';
...
class _EditCustomerState extends State<EditCustomer> {
  ...
  //     );
  //     // var snapshot =
  //     //     await FirebaseStorage.instance.ref('Customer Picture/${DateTime.now().millisecondsSinceEpoch}').putFile(file);
            ...
            child: Padding(
              ...
              child: Column(
                children: [
                  ...
                  //             .ref("${FirebaseAuth.instance.currentUser!.uid}/Customers/$customerKey");
                  //         await ref.update({
